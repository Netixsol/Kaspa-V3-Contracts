...
// File @kasplex/v3-core/contracts/libraries/FixedPoint128.sol@v1.0.2
...
// File contracts/interfaces/IKaspaV3LmPool.sol

pragma solidity >=0.5.0;

interface IKaspaV3LmPool {
...
// File contracts/interfaces/IKaspaV3LmPoolDeveloper.sol

pragma solidity >=0.5.0;

interface IKaspaV3LmPoolDeveloper {
...
// File @kasplex/v3-core/contracts/libraries/LiquidityMath.sol@v1.0.2
...
// File contracts/libraries/LmTick.sol
...
// File contracts/KaspaV3LmPool.sol

pragma solidity =0.7.6;
contract KaspaV3LmPool is IKaspaV3LmPool {
  ...
  IKaspaV3Pool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = IKaspaV3LmPoolDeveloper(msg.sender).parameters();
    pool = IKaspaV3Pool(poolAddress);
...
// File @kasplex/v3-core/contracts/interfaces/IKaspaV3Factory.sol@v1.0.2
...
// File contracts/KaspaV3LmPoolDeployer.sol
