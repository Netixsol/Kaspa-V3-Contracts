...
Record the kfc amount belong to MasterChefV3.
...
```solidity
constructor(contract IERC20 _KFC, contract INonfungiblePositionManager _nonfungiblePositionManager, address _WETH) public
```
...
| ---- | ---- | ----------- |
| _KFC | contract IERC20 | The KFC token contract address. |
...
Update kfc reward for all the liquidity mining pool.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| _to | address | The KFC receiver address. |
| _amount | uint256 | Transfer KFC amounts. |
