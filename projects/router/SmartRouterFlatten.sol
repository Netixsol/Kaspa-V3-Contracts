...
// File @kasplex/v3-periphery/contracts/interfaces/IMulticall.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/base/Multicall.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/IPeripheryImmutableState.sol@v1.0.2
...
interface IPeripheryImmutableState {
    /// @return Returns the address of the Kaspa Finance V3 deployer
    function deployer() external view returns (address);

    /// @return Returns the address of the Kaspa Finance V3 factory
    function factory() external view returns (address);
...
// File @kasplex/v3-periphery/contracts/base/PeripheryImmutableState.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/external/IWETH9.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/IPeripheryPayments.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/libraries/TransferHelper.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/base/PeripheryPayments.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/IPeripheryPaymentsWithFee.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/base/PeripheryPaymentsWithFee.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/base/BlockTimestamp.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/base/PeripheryValidation.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/external/IERC20PermitAllowed.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/ISelfPermit.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/base/SelfPermit.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/IERC721Permit.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/interfaces/IPoolInitializer.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/libraries/PoolAddress.sol@v1.0.2
...
library PoolAddress {
    ...
    /// @param deployer The Kaspa Finance V3 deployer contract address
...
// File @kasplex/v3-periphery/contracts/interfaces/INonfungiblePositionManager.sol@v1.0.2

pragma solidity >=0.7.5;

/// @title Non-fungible token for positions
/// @notice Wraps Kaspa Finance V3 positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
...
// File @kasplex/v3-periphery/contracts/libraries/OracleLibrary.sol@v1.0.2

pragma solidity >=0.5.0 <0.8.0;
/// @title Oracle library
/// @notice Provides functions to integrate with V3 pool oracle
library OracleLibrary {
    /// @notice Calculates time-weighted means of tick and liquidity for a given Kaspa Finance V3 pool
        ...
        returns (int24 arithmeticMeanTick, uint128 harmonicMeanLiquidity)
    {
        ...
        (int56[] memory tickCumulatives, uint160[] memory secondsPerLiquidityCumulativeX128s) =
            IKaspaV3Pool(pool).observe(secondsAgos);
    ...
    /// @param pool Address of Kaspa Finance V3 pool that we want to observe
    /// @return secondsAgo The number of seconds ago of the oldest observation stored for the pool
    function getOldestObservationSecondsAgo(address pool) internal view returns (uint32 secondsAgo) {
        (, , uint16 observationIndex, uint16 observationCardinality, , , ) = IKaspaV3Pool(pool).slot0();
        require(observationCardinality > 0, 'NI');

        (uint32 observationTimestamp, , , bool initialized) =
            IKaspaV3Pool(pool).observations((observationIndex + 1) % observationCardinality);

        // The next index might not be initialized if the cardinality is in the process of increasing
        // In this case the oldest observation is always in index 0
        if (!initialized) {
            (observationTimestamp, , , ) = IKaspaV3Pool(pool).observations(0);
        }
    ...
    /// @param pool Address of Kaspa Finance V3 pool
    /// @return The tick that the pool was in at the start of the current block
    function getBlockStartingTickAndLiquidity(address pool) internal view returns (int24, uint128) {
        (, int24 tick, uint16 observationIndex, uint16 observationCardinality, , , ) = IKaspaV3Pool(pool).slot0();
        ...
        (uint32 observationTimestamp, int56 tickCumulative, uint160 secondsPerLiquidityCumulativeX128, ) =
            IKaspaV3Pool(pool).observations(observationIndex);
        if (observationTimestamp != uint32(block.timestamp)) {
            return (tick, IKaspaV3Pool(pool).liquidity());
        }
        ...
        ) = IKaspaV3Pool(pool).observations(prevIndex);
...
// File @kasplex/v3-periphery/contracts/libraries/BytesLib.sol@v1.0.2
...
// File @kasplex/v3-periphery/contracts/libraries/Path.sol@v1.0.2
...
/// @notice Allows callers to approve the Kaspa Finance V3 position manager from this contract,
...
abstract contract OracleSlippage is IOracleSlippage, PeripheryImmutableState, BlockTimestamp {
    ...
    function getBlockStartingAndCurrentTick(IKaspaV3Pool pool)
        internal
        view
    ...
    function getPoolAddress(
        ...
        address tokenB,
        uint24 fee
    ) internal view virtual returns (IKaspaV3Pool pool) {
        pool = IKaspaV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
        ...
        returns (int256 syntheticAverageTick, int256 syntheticCurrentTick)
    {
        ...
        for (uint256 i = 0; i < numPools; i++) {
            ...
            IKaspaV3Pool pool = getPoolAddress(tokenIn, tokenOut, fee);
            ...
            if (secondsAgo == 0) {
                ...
                (, currentTick, , , , , ) = IKaspaV3Pool(pool).slot0();
            }
...
/// @notice Functions for swapping tokens via Kaspa Stable Swap
...
/// @title Router token swapping functionality
/// @notice Functions for swapping tokens via Kaspa Finance V2
...
interface IV3SwapRouter is IKaspaV3SwapCallback {
...
library SmartRouterHelper {
    ...
    // bytes32 internal constant V2_INIT_CODE_HASH = 0x5901d5094dc38c25423a045dc57ac02ed471c2d2c6a0b6e1e6014505b28dbc5d; // BSC TESTNET
    // bytes32 internal constant V2_INIT_CODE_HASH = 0x5901d5094dc38c25423a045dc57ac02ed471c2d2c6a0b6e1e6014505b28dbc5d; // BSC
    // bytes32 internal constant V2_INIT_CODE_HASH = 0x5901d5094dc38c25423a045dc57ac02ed471c2d2c6a0b6e1e6014505b28dbc5d; // ETH, GOERLI
    bytes32 internal constant V2_INIT_CODE_HASH = 0x5901d5094dc38c25423a045dc57ac02ed471c2d2c6a0b6e1e6014505b28dbc5d;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0x5901d5094dc38c25423a045dc57ac02ed471c2d2c6a0b6e1e6014505b28dbc5d;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (IKaspaV3Pool) {
        return IKaspaV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IKaspaV3Pool pool) {
    ...
    {
        pool = IKaspaV3Pool(computeAddress(deployer, poolKey));
...
/// @title Kaspa Stable Swap Router
abstract contract StableSwapRouter is IStableSwapRouter, PeripheryPaymentsWithFeeExtended, Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Set Kaspa Stable Swap Factory and Info
