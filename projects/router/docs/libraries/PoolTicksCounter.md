...
```solidity
function countInitializedTicksCrossed(contract IKaspaV3Pool self, int24 tickBefore, int24 tickAfter) internal view returns (uint32 initializedTicksCrossed)
```
