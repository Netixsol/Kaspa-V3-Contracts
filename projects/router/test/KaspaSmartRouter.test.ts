...
const KaspaStableSwapFactory = artifacts.require("stable-swap/contracts/KaspaStableSwapFactory.sol");
const KaspaStableSwapLPFactory = artifacts.require("stable-swap/contracts/KaspaStableSwapLPFactory.sol");
const KaspaStableSwapTwoPoolDeployer = artifacts.require("stable-swap/contracts/KaspaStableSwapTwoPoolDeployer.sol");
const KaspaStableSwapThreePoolDeployer = artifacts.require("stable-swap/contracts/KaspaStableSwapThreePoolDeployer.sol");
const KaspaStableSwapTwoPool = artifacts.require("stable-swap/contracts/KaspaStableSwapTwoPool.sol");
const KaspaStableSwapThreePool = artifacts.require("stable-swap/contracts/KaspaStableSwapThreePool.sol");
const KaspaStableSwapTwoPoolInfo = artifacts.require("stable-swap/contracts/utils/KaspaStableSwapTwoPoolInfo.sol");
const KaspaStableSwapThreePoolInfo = artifacts.require("stable-swap/contracts/utils/KaspaStableSwapThreePoolInfo.sol");
const KaspaStableSwapInfo = artifacts.require("stable-swap/contracts/utils/KaspaStableSwapInfo.sol");
const LPToken = artifacts.require("stable-swap/contracts/KaspaStableSwapLP.sol");
...
const KaspaFactory = artifacts.require("exchange-protocol/contracts/KaspaFactory.sol");
const KaspaPair = artifacts.require("exchange-protocol/contracts/KaspaPair.sol");
const KaspaRouter = artifacts.require("exchange-protocol/contracts/KaspaRouter.sol");
...
contract("SmartRouter", ([admin, bob, carol]) => {
    ...
    before(async () => {
        ...
        /** Create Stable Swap */
        stableSwapLPFactory = await KaspaStableSwapLPFactory.new({ from: admin });
        stableSwap2PoolDeployer = await KaspaStableSwapTwoPoolDeployer.new({ from: admin });
        stableSwap3PoolDeployer = await KaspaStableSwapThreePoolDeployer.new({ from: admin });
        stableSwapFactory = await KaspaStableSwapFactory.new(stableSwapLPFactory.address, stableSwap2PoolDeployer.address, stableSwap3PoolDeployer.address, {
            from: admin,
        });
        stableSwap2PoolInfo = await KaspaStableSwapTwoPoolInfo.new({ from: admin });
        stableSwap3PoolInfo = await KaspaStableSwapThreePoolInfo.new({ from: admin });
        stableSwapPoolInfo = await KaspaStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, { from: admin });
        ...
        stable2Pool_BUSD_USDC = await KaspaStableSwapTwoPool.at(stable2PoolInfo.swapContract);
        ...
        stable2Pool_WBNB_BUSD = await KaspaStableSwapTwoPool.at(stable2PoolInfo_WBNB_BUSD.swapContract);
        ...
        stable3Pool_BUSD_USDC_USDT = await KaspaStableSwapThreePool.at(stable3PoolInfo.swapContract);
