...
// File contracts/interfaces/IMixedRouteQuoterV1.sol
...
// File contracts/lens/MixedRouteQuoterV1.sol
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IKaspaV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function kaspaV3SwapCallback(
        ...
        IKaspaV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IKaspaV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
