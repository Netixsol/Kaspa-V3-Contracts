...
export function getCreate2Address(
  ...
  console.log(utils.keccak256(bytecode), 'init code')
...
export function createPoolFunctions({
  ...
  swapTarget: TestKaspaV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeKaspaV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestKaspaV3Router
  poolInput: MockTimeKaspaV3Pool
  poolOutput: MockTimeKaspaV3Pool
}): MultiPoolFunctions {
