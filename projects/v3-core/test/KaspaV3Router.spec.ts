...
describe('KaspaV3Pool', () => {
  ...
  let pool0: MockTimeKaspaV3Pool
  let pool1: MockTimeKaspaV3Pool
  ...
  let swapTargetCallee: TestKaspaV3Callee
  let swapTargetRouter: TestKaspaV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeKaspaV3Pool, any]> => {
