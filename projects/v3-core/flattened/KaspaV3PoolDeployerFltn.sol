...
// File contracts/interfaces/pool/IKaspaV3PoolActions.sol
...
// File contracts/interfaces/pool/IKaspaV3PoolDerivedState.sol
...
// File contracts/interfaces/pool/IKaspaV3PoolEvents.sol
...
// File contracts/interfaces/pool/IKaspaV3PoolImmutables.sol
...
// File contracts/interfaces/pool/IKaspaV3PoolOwnerActions.sol
...
// File contracts/interfaces/pool/IKaspaV3PoolState.sol
...
// File @kasplex/v3-lm-pool/contracts/interfaces/IKaspaV3LmPool.sol@v1.0.0
...
// File contracts/interfaces/callback/IKaspaV3FlashCallback.sol
...
// File contracts/interfaces/callback/IKaspaV3MintCallback.sol
...
// File contracts/interfaces/callback/IKaspaV3SwapCallback.sol
...
// File contracts/interfaces/IKaspaV3Factory.sol
...
// File contracts/interfaces/IKaspaV3PoolDeployer.sol
...
interface IKaspaV3PoolDeployer {
...
// File contracts/KaspaV3Pool.sol

pragma solidity =0.7.6;
contract KaspaV3Pool is IKaspaV3Pool {
    using LowGasSafeMath for uint256;
    using LowGasSafeMath for int256;
    using SafeCast for uint256;
    using SafeCast for int256;
    ...
    /// @inheritdoc IKaspaV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IKaspaV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IKaspaV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IKaspaV3PoolDerivedState
    function snapshotCumulativesInside(int24 tickLower, int24 tickUpper)
        external
        view
        override
    ...
    /// @inheritdoc IKaspaV3PoolActions
    ...
    function mint(
        ...
        IKaspaV3MintCallback(msg.sender).kaspaV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IKaspaV3SwapCallback(msg.sender).kaspaV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IKaspaV3FlashCallback(msg.sender).kaspaV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IKaspaV3PoolOwnerActions
