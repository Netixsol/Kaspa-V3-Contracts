...
// File @openzeppelin/contracts/introspection/ERC165.sol@v3.4.2-solc-0.7
...
// File @openzeppelin/contracts/utils/EnumerableMap.sol@v3.4.2-solc-0.7
...
// File @openzeppelin/contracts/token/ERC721/ERC721.sol@v3.4.2-solc-0.7
...
// File @kasplex/v3-core/contracts/interfaces/callback/IKaspaV3MintCallback.sol@v1.0.2
...
library CallbackValidation {
    /// @notice Returns the address of a valid Kaspa V3 Pool
    /// @param deployer The contract address of the Kaspa V3 Deployer
    /// @param tokenA The contract address of either token0 or token1
    /// @param tokenB The contract address of the other token
    /// @param fee The fee collected upon every swap in the pool, denominated in hundredths of a bip
...
// File @kasplex/v3-core/contracts/libraries/FixedPoint96.sol@v1.0.2
...
/// @notice Internal functions for safely managing liquidity in Kaspa V3
abstract contract LiquidityManagement is IKaspaV3MintCallback, PeripheryImmutableState, PeripheryPayments {
    struct MintCallbackData {
        PoolAddress.PoolKey poolKey;
        address payer;
    }

    /// @inheritdoc IKaspaV3MintCallback
    function kaspaV3MintCallback(
        uint256 amount0Owed,
        uint256 amount1Owed,
        bytes calldata data
    ...
    SelfPermit
{
    ...
    ) ERC721Permit('Kaspa V3 Positions NFT-V1', 'PCS-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IKaspaV3Pool pool = IKaspaV3Pool(PoolAddress.computeAddress(deployer, poolKey));
