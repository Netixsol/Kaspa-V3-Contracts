...
const artifacts: { [name: string]: ContractJson } = {
  ...
  KaspaInterfaceMulticall: require('../artifacts/contracts/lens/KaspaInterfaceMulticall.sol/KaspaInterfaceMulticall.json'),
...
async function main() {
  ...
  const baseTokenUri = 'https://nft.kaspaswap.com/v3/'
  ...
  const KaspaInterfaceMulticall = new ContractFactory(
    artifacts.KaspaInterfaceMulticall.abi,
    artifacts.KaspaInterfaceMulticall.bytecode,
    owner
  )
