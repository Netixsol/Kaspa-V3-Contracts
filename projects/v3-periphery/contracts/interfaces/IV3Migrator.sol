...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from Kaspa Finance v2-compatible pairs into Kaspa Finance v3 pools
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the Kaspa Finance v2-compatible pair
