...
import '@kasplex/v3-core/contracts/interfaces/callback/IKaspaV3FlashCallback.sol';
...
/// @notice An example contract using the Kaspa Finance V3 flash function
contract PairFlash is IKaspaV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `KaspaV3FlashCallback`
