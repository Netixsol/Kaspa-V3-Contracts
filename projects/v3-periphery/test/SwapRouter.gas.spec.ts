...
import { IKaspaV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IKaspaV3Pool, IKaspaV3Pool, IKaspaV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IKaspaV3PoolABI, wallet)) as [
      IKaspaV3Pool,
      IKaspaV3Pool,
      IKaspaV3Pool
    ]
  ...
  let pools: [IKaspaV3Pool, IKaspaV3Pool, IKaspaV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestKaspaV3Callee')
