...
await $`yarn workspace @kasplex/v3-core run hardhat run scripts/deploy.ts --network ${network}`

await $`yarn workspace @kasplex/v3-periphery run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @kasplex/smart-router run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @kasplex/masterchef-v3 run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @kasplex/v3-lm-pool run hardhat run scripts/deploy2.ts --network ${network}`
